...
function colony_test
{
    ...
    truffle_setup https://github.com/solidity-external-tests/colonyNetwork.git develop
    run_install install_fn

    cd lib
    rm -Rf dappsys
    git clone https://github.com/solidity-external-tests/dappsys-monolithic.git -b master dappsys
    cd ..
